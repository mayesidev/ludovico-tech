...
export const Card = ({
  ...
  <section
    className={cn(
      "rounded-3xl border border-white/10 bg-white/[0.055] shadow-2xl shadow-black/20",
      className,
    )}
  >
    {children}
...
export const Badge = ({
  ...
  <span
    className={cn(
      "inline-flex items-center rounded-full border border-white/10 bg-white/8 px-2.5 py-1 text-xs font-medium text-zinc-300",
      className,
    )}
  >
    {children}
...
export const SectionHeading = ({
  ...
  <div className="mb-5">
    <p className="mb-2 text-xs font-bold uppercase tracking-[0.22em] text-lime-300">
      {eyebrow}
    </p>
