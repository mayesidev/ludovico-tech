...
| Import                 | Private headings/values never enter diagnostics; deterministic IDs; exact submission dedupe; same-title works remain distinct; IMDb title-reference validation; franchise inconsistency report; strict rating parsing; stale generated chunks removed; rerun idempotency | Node unit and local D1 integration |
